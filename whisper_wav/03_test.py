...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(exp_dir, unit+'_model_conv_nar')
    ...
    fe_conv_dropout = config['fe_conv_dropout_rate']
    ...
    #enc_dropout_rate = config['enc_dropout']
    enc_dropout = config['enc_dropout_rate']
    ...
    #dec_dropout_rate = config['dec_dropout']
    ...
    test_dataset = SequenceDataset(wav_scp_test,
                                   label_test,)
                                   #feat_mean,
                                   #feat_std)
